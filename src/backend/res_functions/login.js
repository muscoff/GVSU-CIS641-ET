...
const Login = (req, res) => {
    ...
    if(findUserInfo){
        res.json({status: true, username, details: findUserInfo})
        return
    }
    res.json({status: true, username, details: {}})
}
...
const createLogin = (req, res) => {
    ...
    try{
        ...
        const data = [...loginDb, {username, password: hash, admin: false}]
